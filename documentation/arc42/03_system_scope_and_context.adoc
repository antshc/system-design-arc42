...
| User
| Image Uploads Specs:
Formats: Common image formats (JPEG, PNG).
Max Size: Images might have a size limit (e.g., 10 MB per image), no videos and gifts support.
Resolution: Input resolution may be constrained to certain max dimensions (e.g., 1080x1080 for square images).
